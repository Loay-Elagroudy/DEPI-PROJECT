"""
Standalone optimization entry point -- runs all four Milestone 2 optimization
experiments (prompt, embedding model, chunk size/overlap, retrieval strategy)
and writes `optimization_experiments_report.md`, exactly as notebook cell 53's
final block. Independent of the API.
