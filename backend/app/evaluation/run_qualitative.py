"""
Qualitative test-query run -- preserves notebook cell 39 exactly.
Runs the 9 fixed test queries through the live RAG chain and writes
`evaluation_report.txt`, independent of the API.
"""
...
def run_qualitative_eval(output_path: Optional[str] = None, queries: Optional[List[str]] = None) -> str:
    ...
    for i, query in enumerate(queries, 1):
        ...
        except Exception as e:  # noqa: BLE001 -- preserved from notebook
