"""
Standalone evaluation entry point -- runs qualitative + generation +
retrieval evaluation independently of the API, exactly as in the notebook's
"Final Reports Summary" (cell 54), producing the same three report files:
