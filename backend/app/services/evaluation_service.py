"""
Evaluation service -- thin orchestration layer over the evaluation modules
so both the API and standalone scripts (`app.evaluation.run_all`) share the
exact same underlying logic.
"""
from typing import Any, Dict, List

from app.evaluation.generation_metrics import EVAL_DATASET, run_generation_evaluation
from app.evaluation.retrieval_metrics import build_ground_truth_ids, run_retrieval_evaluation
